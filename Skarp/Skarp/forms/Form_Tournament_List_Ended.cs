...
namespace Skarp.forms {
    public partial class Form_Tournament_List_Ended : Form {
        ...
        accueil form_parent_;

        public Form_Tournament_List_Ended ( accueil form_parent ) {

            InitializeComponent();
            // chargement datas
            allTournaments = new Tournament();
            dataSetAllTournaments = allTournaments.getTournamentOfTheSession();
            form_parent_ = form_parent;
        ...
        private void lb_voir_detail_LinkClicked ( object sender , LinkLabelLinkClickedEventArgs e ) {

            form_parent_.voirDetailsTournament( allTournaments.idTournament );
